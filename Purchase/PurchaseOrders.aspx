<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="PurchaseOrders.aspx.cs" Inherits="SimpleERP.Purchase.PurchaseOrders" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="body" runat="server">
    ...
    <div>
        <asp:GridView ID="gvPurchaseorders" runat="server" AutoGenerateColumns="false" DataKeyNames="PurchaseOrderID" OnRowDataBound="gvPurchaseorders_RowDataBound" CssClass="Grid">
            <Columns>
