<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="InventoryReport.aspx.cs" Inherits="SimpleERP.Reports.InventoryReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
     <asp:GridView ID="gvInventory" runat="server" AutoGenerateColumns="true" DataKeyNames="">
    </asp:GridView>
