<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="SimpleERP.Admin.Users" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="true" DataKeyNames="Userid">
                <Columns>
