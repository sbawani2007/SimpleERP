<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesInvoice.aspx.cs"  MasterPageFile="~/Site1.Master" Inherits="SimpleERP.Sales.SalesInvoice" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="body" runat="server">
    <div>
            <asp:GridView ID="gvSalesorders" runat="server" AutoGenerateColumns="false" DataKeyNames="SalesOrderID" OnRowDataBound="gvSalesorders_RowDataBound"
                CssClass="Grid" OnRowCommand="gvSalesorders_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkCreateInvoice" runat="server" CommandName="Add" CommandArgument='<%# Eval("SalesOrderID") %>' Text="Create Invoice"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
